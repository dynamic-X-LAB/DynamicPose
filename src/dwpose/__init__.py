...
def save_pose_info(pose, H, W):
    ...
    save_info = {
        'W': W,
        'H': H,
        'bodies.candidate': str(np.around(candidate,4)),
        'bodies.subset': str(np.around(subset,4)),
        'bodies.score':str(np.around(body_score,2)),
        'faces': str(np.around(faces,4)),
        'hands': str(np.around(hands,4)),
        'foot': str(np.around(foot,4)),
        'faces_score':str(np.around(faces_score,2)),
        'hands_score':str(np.around(hands_score,2)),
        'foot_score':str(np.around(foot_score,2)),
    }
    return save_info
