...
logger = get_new_logger('./log_dir', 'log_{}.log'.format(datetime.now().strftime('%Y%m%d_%H%M%S')))
...
class UNet3DConditionModel(ModelMixin, ConfigMixin):
    ...
    def from_pretrained_2d(
        ...
        logger.info(f"mm_zero_proj_out={mm_zero_proj_out}, motion_module_path={motion_module_path}")
        ...
        if motion_module_path.exists() and motion_module_path.is_file():
            ...
            print(f"mm_zero_proj_out={mm_zero_proj_out}")
            if mm_zero_proj_out:
